...
// parseInt converts the string into number.
...
// we can use alert also with the console as console prints the value in console and alert tells the result on browser.
